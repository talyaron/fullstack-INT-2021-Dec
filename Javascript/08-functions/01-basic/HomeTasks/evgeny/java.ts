...
function tellFortune ( job:string, geoloc:string,spouse :string, numkids:number , ){
...
function calculateDogAge (age:number, puppyage = 7*age ){ 
...
function calculateSupply (age:number, amountday:number){
    var maxage = 120
...
function elsiusToFahrenheit (celsius:number ){
