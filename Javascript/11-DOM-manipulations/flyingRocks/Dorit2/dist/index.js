...
var canvas = document.querySelector('canvas'); //canvas from html
var ctx = canvas.getContext('2d');
var width = canvas.width = window.innerWidth; //get width of page
var height = canvas.height = window.innerHeight; //get height of page
// console.log(canvas)
