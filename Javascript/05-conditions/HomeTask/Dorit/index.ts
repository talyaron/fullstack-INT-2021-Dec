...
var fullRate1:number = (stairs[1] - stairs[0]) * percents[1] + fullRate0;
var fullRate2:number = (stairs[2] - stairs[1]) * percents[2] + fullRate1;
var fullRate3:number = (stairs[3] - stairs[2]) * percents[3] + fullRate2;
var fullRate4:number = (stairs[4] - stairs[3]) * percents[4] + fullRate3;
var fullRate5:number = (stairs[5] - stairs[4]) * percents[5] + fullRate4;
var ind:number = 0;
