var array = [1, "x", 32, 42, 51, "abcd", 11, "ajax", "emma", "takemichi", 12, 1];
function arraySort(array, typeInput) {
    ...
    if (typeInput == 'numbers' || typeInput == 'strings') {
        ...
        console.log("you entered " + typeInput + ", it is not a string and not a number");
}
