const arr:Array<any> = ['sim-harif', 5, 'moti-lohim' , 10, 50, 150, 'sami-saviv' , true];
...
const returnTypedArray = (arr:Array<any>, variable:any):Array<any> => {
...
const addOragnToArray = (arr:Array<any> , variable:any):Array<any> =>{
