...
var profText = document.querySelector(".navbar .nav-item .profText");
var userRightTextProfileTextTemplate = document.querySelector('#rightTextProfileTextTemplate');
// HEADER
hamburger.addEventListener("click", function () {
    hamburger.classList.toggle("active");
    navMenu.classList.toggle("active");
});
document.querySelectorAll(".nav-link").forEach(function (n) { return n.addEventListener("click", function () {
    hamburger.classList.remove("active");
    navMenu.classList.remove("active");
}); });
var registration = document.querySelector("#root");
var registerUserDataMain = {};
var products = [];
var registeredUsers = [];
...
function handleProfileCard(ev) {
    ...
    var imageSrc = URL.createObjectURL(imageCardProfile);
...
var productImage = document.querySelector('#productImageUpload');
var mainProductPage = document.querySelector('#mainProductPage');
var imageProductTemplate = document.querySelector('#upload_img_label');
var productsList = [];
var addProductImage;
function handleAddProduct(ev) {
    ...
    var imgSrc = URL.createObjectURL(addProductImage);
    newProduct.id = uid();
    ...
    document.querySelector('.wrapper .addProductTemplate').style.display = 'none';
...
function renderProducts() {
    var productMainID = document.querySelector('#productMainID');
    var html = '';
...
function displayAddProductTemplate() {
    document.querySelector('.wrapper .addProductTemplate').style.display = 'flex';
}
function displayEditProductTemplate() {
    document.querySelector('.wrapper .editProductTemplate').style.display = 'flex';
}
///////////////////////////////////////////////////////////////////
function handleEditProduct(ev) {
    var editProductTemplate = document.querySelector('.wrapper .editProductTemplate');
    var html = '';
    for (var i = 0; i < ev.composedPath().length; i++) {
        for (var j = 0; j < ev.composedPath().length; j++) {
