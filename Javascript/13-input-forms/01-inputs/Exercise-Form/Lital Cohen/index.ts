...
function checkThePassword(event) {
  ...
  if (
    ...
    // ifPsMatch(valueOfPass)
    // console.log("user name + ps yes");
    document.body.style.backgroundColor = "green";
    let outPutOfPassRe: HTMLElement=document.getElementById("passwordLogin");
    outPutOfPassRe.innerHTML =(`${valueOfPass.innerHTML} + ${valueOfPassLog.innerHTML}`)
